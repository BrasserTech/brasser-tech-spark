...
import heroImage from "@/assets/hero-bg.jpg"; // (Caminho baseado na sua imagem)
...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* Partículas (removi para encurtar, seu código original está correto) */}
      {/* ... seu código de partículas ... */}
      ...
      <div className="container mx-auto px-4 z-10 text-center">
        ...
        >
          ...
          {/* Botão Corrigido (sem os comentários de sintaxe inválida) */}
          <Button
            size="lg"
            variant="outline"
